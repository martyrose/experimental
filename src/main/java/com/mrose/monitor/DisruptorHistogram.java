 ...
 */
public final class DisruptorHistogram
{
    private static final Logger log = LoggerFactory.getLogger(DisruptorHistogram.class);
     ...
     */
    public DisruptorHistogram(final long[] upperBounds)
    {
     ...
     */
    public void addObservations(final DisruptorHistogram histogram)
    {
